...
function wzx() {
    ...
    document.addEventListener('visibilitychange', function() {
        if (document.hidden) {
            ...
            document.title = '/(ㄒoㄒ)/喔唷，崩溃啦！';
            clearTimeout(titleTime);
        } else {
            $('[rel="icon"]').attr('href', "https://cdn.jsdelivr.net/gh/wzxyy/cdn@1.1/favicon.ico");
            $('[rel="shortcut icon"]').attr('href', "https://cdn.jsdelivr.net/gh/wzxyy/cdn@1.1/favicon.ico");
